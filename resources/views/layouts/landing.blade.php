...
<head>
	...
	<!-- Favicon  -->
    <link rel="icon" href="images/apii.png">
</head>
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <a class="navbar-brand logo-text page-scroll" href="index.html">IOT</a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1>WEB IOT <br>FOR <span id="js-rotating">MONITORING,UPDATE</span></h1>
                            <p class="p-large">Web and IOT Technology Monitoring</p>
                            <a class="btn-solid-lg page-scroll" href="{{ route('login') }}"><i class=""></i>Login</a>
                            <a class="btn-solid-lg page-scroll" href="{{ route('register') }}"><i class=""></i>Register</a>
                        </div>
                    </div> <!-- end of col -->
                    <div class="col-lg-6">
